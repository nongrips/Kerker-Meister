...
func _ready():
	oRoundPathNearLiquid.toggled.connect(toggled_frail_checkbox.bind("round_path_near_liquid"))
	oRoundEarthNearPath.toggled.connect(toggled_frail_checkbox.bind("round_earth_near_path"))
	oRoundEarthNearLiquid.toggled.connect(toggled_frail_checkbox.bind("round_earth_near_liquid"))
	oRoundRockNearPath.toggled.connect(toggled_frail_checkbox.bind("round_rock_near_path"))
	oRoundRockNearLiquid.toggled.connect(toggled_frail_checkbox.bind("round_rock_near_liquid"))
	oRoundGoldNearPath.toggled.connect(toggled_frail_checkbox.bind("round_gold_near_path"))
	oRoundGoldNearLiquid.toggled.connect(toggled_frail_checkbox.bind("round_gold_near_liquid"))
	oRoundWaterNearLava.toggled.connect(toggled_frail_checkbox.bind("round_water_near_lava"))
